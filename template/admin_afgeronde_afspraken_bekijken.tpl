                ...
                <div class="span12">
                    ...
                    <table class="table bordered striped hovered">
                        ...
                        <tr>
                            ...
                            <td><b>{KID}</b></td>
                            <td><b>{AID}</b></td>
                            <td>{AANVRAAG}... <a class="place-right" href="index.php?id=23&action=details&afid={AFID}">[details]</a></td>
                    ...
                    <a href="index.php?id=23"><input class="large info" name="terug" type="button" value="Terug"></a>
