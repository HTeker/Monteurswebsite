                ...
                <div class="span12">
                    ...
                    <table class="table bordered striped hovered">
                        ...
                        <tr>
                            <td><b>{FID}</b></td>
                            <td><b>{KID}</b></td>
                            <td><b>{OMSCHRIJVING}</b>... <a class="place-right" href="index.php?id=14&action=details&fid={FID}">[details]</a></td>
                    ...
                    <a href="index.php?id=14"><input class="large info" name="terug" type="button" value="Terug"></a>
                    ...
                    <h3 class="text-center"><b>U heeft nog geen facturen gemaakt</h3>
                    <h3 class="text-center" style="font-size: 16px;"><b><a href="index.php?id=15">Klik hier om een factuur te maken</a></h3>
